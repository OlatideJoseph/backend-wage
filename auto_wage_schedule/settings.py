"""
Django settings for auto_wage_schedule project.
...
SECRET_KEY = 'django-insecure-w=1yhe*(5j5%yu4y485drvjj4wc_pwnxc6&)^i@lsk%u!+(*xk'
...
WSGI_APPLICATION = 'auto_wage_schedule.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'schedule'),
